...
namespace GSBFrais.Model.Data
    {
        public class DaoFicheFrais
        {
            ...
            public DaoFicheFrais(Dbal unDbal, DaoVisiteur unDaoVisiteurs, DaoEtat unDaoEtat, DaoLigneFraisForfait unDaoLigneFraisForfait, DaoLigneFraisHorsForfait unDaoLigneFraisHorsForfait)
            {
                this._dbal = unDbal;
